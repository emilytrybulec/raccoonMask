...
process RepeatMasker {
  ...
  container "${ workflow.containerEngine == 'singularity' && !task.ext.singularity_pull_docker_container ?
        'https://depot.galaxyproject.org/singularity/repeatmasker:4.1.7p1--pl5321hdfd78af_0' :
        'biocontainers/repeatmasker:4.1.7p1--pl5321hdfd78af_0' }"
  ...
  def libDir = "echo ${curation_fasta}"
  def libOpt = lib.contains('.fa') ? "-lib ${curation_fasta}" : lib ? "-libdir $curation_fasta/ ${species}" :  "${species}"
  """
  #
  # Run RepeatMasker
  #
